                                ...
                                child: ListView(
                                  children: [
                                    ...
                                    CustomTextField(
                                      ...
                                      onChanged: (value) {
                                        _salesData.quantity = int.parse(value);
                                      },
                                    ),
                                    CustomTextField(
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        saleData.insertSale(_salesData);
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Row(
                                      ...
                                      children: [
                                        Text(
                                          'Product : ${resultSales.productName}',
                                          style: TextStyle(
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        'Quantity : ${resultSales.quantity.toString()}',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w600),
                                      ),
                                      Text(
                                          'Per Sale Amount : ${resultSales.saleAmount}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                    ...
                                    children: [
                                      Text('Date : ${resultSales.salesDate}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.w600)),
                                      Text(
                                          'Total Amount : ${resultSales.saleAmount * resultSales.quantity}',
                                          style: TextStyle(
                                              fontWeight: FontWeight.bold))
                                    ],
                                  ),
